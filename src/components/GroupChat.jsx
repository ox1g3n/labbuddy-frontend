...
function GroupChat() {
  ...
  return (
    <div className='flex flex-col h-full bg-gray-900 text-gray-200 rounded-lg shadow-md overflow-hidden border border-gray-700'>
      ...
      {error && (
        <div className='p-2 bg-red-500/20 text-red-400 text-center text-sm flex-shrink-0'>
          {error}
        </div>
      )}
      ...
      <div className='flex-1 overflow-y-auto p-4 space-y-4 bg-gray-900'>
        ...
        {messages.map((msg) => {
          ...
          return (
            ...
            >
              <div
                className={`max-w-xs lg:max-w-md px-3 py-2 rounded-lg shadow ${isCurrentUser ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-200'}`}
              >
                {isCurrentUser && (
