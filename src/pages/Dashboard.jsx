  ...
  return (
    <div className='flex h-screen bg-gray-900'>
      ...
      <div className='w-1/5 bg-gradient-to-b from-gray-800 to-gray-900 text-white flex flex-col justify-between border-r border-gray-700'>
        <div>
          <h2
            className='text-center text-3xl font-bold py-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 cursor-pointer'
      ...
      {showAiModal && (
        <div className='fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center p-4'>
          <div
            className='bg-gray-800 p-6 rounded-xl shadow-2xl w-3/4 max-w-4xl border border-gray-700 flex flex-col'
            style={{ maxHeight: 'calc(100vh - 2rem)' }}
          >
            <h2 className='text-2xl font-bold mb-4 text-gray-200 flex-shrink-0'>
              Get AI Help
            </h2>
            <select
              value={aiAction}
                ...
                <div className='prose prose-invert max-w-none'>
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      pre: ({ _node, ...props }) => (
                        <pre
                          className='bg-gray-800 p-4 rounded-lg overflow-x-auto mb-4 whitespace-pre-wrap'
                          {...props}
                        />
                      ),
